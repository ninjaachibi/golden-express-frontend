        ...
        <Animated.View
         ...
         <TouchableOpacity style={{position:'absolute', top:-21,left:-10,right:SCREEN_WIDTH*1/3}} onPress={() => this.subtract()}>
           <Text style={{fontSize:32}}> - </Text>
              ...
              <Text style={{position:'absolue', top:-13.75,left:67,right:0, fontSize: 22, fontWeight:'bold'}}>{this.state.quantity}</Text>
              <TouchableOpacity style={{position:'absolute', top:-21,left:SCREEN_WIDTH*1/3,right:-10}} onPress={() => this.add()}>
                <Text style={{fontSize:32}}> + </Text>
                   </TouchableOpacity>
          </Card>
            <TouchableOpacity style={{borderRadius: 8,height:30,position:'absolute', top:13.5,left:SCREEN_WIDTH*15/29,right:0,zIndex:2,marginLeft:-2.5,marginTop:-10,
            width: SCREEN_WIDTH * 0.48, backgroundColor:'red', alignItems:'center', justifyContent:'center',
